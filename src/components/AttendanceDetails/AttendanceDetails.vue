                ...
                <view class="attendance-main">
                    ...
                    <view class="attendance-content">
                        ...
                        <view class="right">
                            ...
                            <view class="not-pass">
                                {{
                                    attendanceData.total >= attendanceData.attendanceTimerMin
                                        ? '已合格'
                                        : '与合格时长相差' + (attendanceData.attendanceTimerMin - attendanceData.total) + '分钟'
                                }}
                            </view>
                        </view>
                    </view>
...
const grid = [{ day1: 0 }, { day2: 0 }, { day3: 0 }, { day4: 0 }, { day5: 0 }, { day6: 0 }, { day7: 0 }];
const curGrid = ref([]);
...
const refresh = async (callback: () => void) => {
    ...
    try {
        ...
        attendanceType === '2'
            ? await useLesson.queryDurationCourse({ courseid: curCourseid.value })

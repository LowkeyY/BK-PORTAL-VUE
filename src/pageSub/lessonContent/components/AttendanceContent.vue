...
<template>
    <view>
        <pull-refresh-list type="content" :loading="loading" :has-more="false" :is-refresh="isRefresh" @on-refresh="refresh">
            <view v-if="lessonData.attendanceType==='1'">
                <view class="refresh">
                    <text>
                        数据更新时间：
                ...
                <view class="attendance-main">
                    <view class="left">
                        <view class="left-detail">开课时间:{{ `${changeLessonDate(lessonData.startdate)}-${changeLessonDate(lessonData.enddate)}` }}</view>
            ...
            <view v-if="lessonData.attendanceType==='2'">
                <view class="attendance-main">
                    <view class="left">
                        <view class="left-detail">开课时间:{{ `${changeLessonDate(lessonData.startdate)}` }}</view>

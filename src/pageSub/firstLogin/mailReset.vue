...
<template>
    <app-provider>
        ...
        <view class="container">
            ...
            <view class="content">
                <uni-forms ref="emailFormRef" :model-value="emailForm" :rules="rules">
                    <uni-forms-item name="email">
                        <template #default>
                            <uni-easyinput v-model="emailForm.email" prefix-icon="email-filled" class="input-container">
                            </uni-easyinput>
                        </template>
                    </uni-forms-item>

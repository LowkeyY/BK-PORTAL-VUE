...
export function  getItemFormLabel(item){
    item.template = 'label';
    return item;
}

export function   getItemFormInfo (item){
    item.template = 'label';
...
export function   getItemFormNumeric (item)  {
...
export function getItemFormTextfield (item){
...
export function getItemFormTextarea (item){
    item.template = 'textarea';
    item.value = typeof item.responsevalue !== 'undefined' ? item.responsevalue : '';
    return item;
}

export function getItemFormMultichoice (item)  {
